...
public class CameraActivity extends AppCompatActivity {
    ...
    private static String phtotPath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShareSDK.initSDK(CameraActivity.this, "1d354b908394b");
        ...
        takePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(CameraActivity.this, outputImage + "", Toast.LENGTH_LONG).show();
                phtotPath = outputImage + "";
                try {
                ...
                if (Build.VERSION.SDK_INT < 24) {
                    ...
                    imageUri = FileProvider.getUriForFile(CameraActivity.this,
                            "com.ybc.fileprovider", outputImage);
                }
                // 启动相机程序
    ...
    *创建File对象，用于存储拍照后的图片 */
    private void firstTakePhoto() {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            imageUri = FileProvider.getUriForFile(CameraActivity.this,
                    "com.cameraalbumtest.fileprovider", outputImage);
        }
        // 启动相机程序
        Intent intent = new Intent("android.media.action.IMAGE_CAPTURE");
        intent.putExtra(MediaStore.EXTRA_OUTPUT, imageUri);
...
// text是分享文本，所有平台都需要这个字段
        oks.setText("来自BmBHome的分享");
// imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
        oks.setImagePath(getExternalCacheDir() + "/output_image.jpg");//确保SDcard下面存在此张图片
        ...
        oks.setShareContentCustomizeCallback(new ShareContentCustomizeCallback() {
            ...
            public void onShare(Platform platform, Platform.ShareParams paramsToShare) {
                if (platform.getName().equalsIgnoreCase(QQ.NAME)) {
                    ...
                    paramsToShare.setImagePath(getExternalCacheDir() + "/output_image.jpg");
